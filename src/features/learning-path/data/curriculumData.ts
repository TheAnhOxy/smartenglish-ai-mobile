    ...
    units: [
      {
        id: 'u-1',
        unit_number: 1,
        title_vi: 'Unit 1: Chào Hỏi & Giới Thiệu Bản Thân',
        title_en: 'Unit 1: Greetings & Self-Introduction',
      ...
      },
      {
        id: 'u-2',
        unit_number: 2,
        title_vi: 'Unit 2: Gia Đình & Bạn Bè',
        title_en: 'Unit 2: Family & Friends',
        description_vi: 'Mô tả các mối quan hệ thân thiết, gia đình và bạn bè trong đời sống.',
        is_premium: false,
        status: 'current',
        icon_type: 'grad',
        total_lessons: 5,
      ...
      },
      {
        id: 'u-3',
        unit_number: 3,
        title_vi: 'Unit 3: Mua Sắm & Giá Cả',
        title_en: 'Unit 3: Shopping & Prices',
      ...
      },
      {
        id: 'u-4',
        unit_number: 4,
        title_vi: 'Unit 4: Đi Lại & Hỏi Đường',
        title_en: 'Unit 4: Commuting & Directions',
        description_vi: 'Kỹ năng hỏi đường, phương tiện giao thông và di chuyển công cộng.',
        is_premium: false,
        status: 'unlocked',
        icon_type: 'speech',
        total_lessons: 5,
      ...
      },
      {
        id: 'u-5',
        unit_number: 5,
        title_vi: 'Unit 5: Phỏng Vấn Xin Việc Thành Công 👑',
        title_en: 'Unit 5: Successful Job Interview',
        description_vi: 'Bí quyết và kỹ năng trả lời phỏng vấn xin việc bằng tiếng Anh ấn tượng.',
        is_premium: true,
        status: 'unlocked',
        icon_type: 'crown',
        total_lessons: 5,
      ...
      },
      {
        id: 'u-6',
        unit_number: 6,
        title_vi: 'Unit 6: Mở Rộng Từ Vựng & Kỹ Năng Tổng Hợp',
        title_en: 'Unit 6: Vocabulary Expansion & Integrated Skills',
        description_vi: 'Mở rộng vốn từ vựng thực tế và rèn luyện kỹ năng tổng hợp đa chiều.',
        is_premium: false,
        status: 'unlocked',
        icon_type: 'star',
        total_lessons: 5,
      ...
      },
      {
        id: 'u-7',
        unit_number: 7,
        title_vi: 'Unit 7: Video & Luyện Phản Xạ Nâng Cao',
        title_en: 'Unit 7: Video & Advanced Reflex Practice',
        description_vi: 'Luyện nghe nói phản xạ chuyên sâu qua video clip bản ngữ sinh động.',
        is_premium: false,
        status: 'unlocked',
        icon_type: 'grad',
        total_lessons: 5,
      ...
      },
      {
        id: 'u-8',
        unit_number: 8,
        title_vi: 'Unit 8: Video & Đánh Giá Tổng Hợp 👑',
        title_en: 'Unit 8: Video & Comprehensive Assessment',
        description_vi: 'Đánh giá toàn diện kiến thức Chương 1 qua bài học video tương tác chuẩn quốc tế.',
        is_premium: true,
        status: 'locked',
        icon_type: 'crown',
        total_lessons: 6,
